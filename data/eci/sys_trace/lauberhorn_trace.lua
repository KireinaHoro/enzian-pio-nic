...
ef.intc_kind = ProtoField.string("lhtrace.eci.intc.kind", "VC12 Interrupt Kind")
ef.intc_word = ProtoField.uint8("lhtrace.eci.intc.word", "VC12 Interrupt Word", base.DEC)
ef.intc_cmd = ProtoField.uint8("lhtrace.eci.intc.cmd", "VC12 Interrupt Command", base.HEX)
ef.intc_intid = ProtoField.uint8("lhtrace.eci.intc.intid", "VC12 Interrupt ID", base.DEC)
ef.intc_affinity0 = ProtoField.uint16("lhtrace.eci.intc.affinity0", "VC12 Interrupt Affinity 0", base.HEX)
ef.intc_affinity1 = ProtoField.uint8("lhtrace.eci.intc.affinity1", "VC12 Interrupt Affinity 1", base.DEC)

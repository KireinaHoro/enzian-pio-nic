...
#
# Generated by Vivado on Wed Feb 21 15:58:40 CET 2024
...
set orig_proj_dir "[file normalize "$origin_dir/../../out/pcie/vivadoProject.dest/pio-nic-pcie"]"
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../out/pcie/vivadoProject.dest/pio-nic-pcie/pio-nic-pcie.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {

...
#
# create_project.tcl: Tcl script for re-creating project 'pio-nic-pcie'
#
# Generated by Vivado on Thu Feb 08 18:04:48 CET 2024
...
#
#    "/scratch/pengxu/enzian-pio-nic/vivado/pcie/xdc/enzian_pcie.xdc"
#    "/scratch/pengxu/enzian-pio-nic/vivado/pcie/xdc/floorplan.xdc"
#    "/scratch/pengxu/enzian-pio-nic/deps/spinal-blocks/deps/verilog-axis/syn/vivado/axis_async_fifo.tcl"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../../deps/spinal-blocks/deps/verilog-axis/syn/vivado/axis_async_fifo.tcl"]"\
  ]
  foreach ifile $files {
...
set origin_dir "/scratch/pengxu/enzian-pio-nic/vivado/pcie"
...
set _xil_proj_name_ "pio-nic-pcie"
...
set orig_proj_dir "[file normalize "$origin_dir/../out/pioNicEngineModule/vivadoProject.dest/pio-nic-pcie"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../deps/spinal-blocks/deps/verilog-axis/syn/vivado/axis_async_fifo.tcl"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../deps/spinal-blocks/deps/verilog-axis/syn/vivado/axis_async_fifo.tcl"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../out/pioNicEngineModule/vivadoProject.dest/pio-nic-pcie/pio-nic-pcie.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {

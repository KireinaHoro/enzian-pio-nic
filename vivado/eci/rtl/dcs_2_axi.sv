...
module dcs_2_axi #
  (
   ...
   (
    ...
    output logic                       p_axi_aruser,
    output logic [3:0]                 p_axi_arregion,
    output logic [3:0]                 p_axi_arqos,
    ...
    output logic                       p_axi_awuser,
    output logic [3:0]                 p_axi_awregion,
    output logic [3:0]                 p_axi_awqos,

...
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME =~ i_app/dcs_even/i_chan_pipe_lcl_*_slave/*slr_auto_src*}]
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME =~ i_app/dcs_even/i_chan_pipe_lcl_*_master/*slr_auto_dest*}]
...
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME =~ i_app/dcs_odd/i_chan_pipe_lcl_*_slave/*slr_auto_src*}]
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME =~ i_app/dcs_odd/i_chan_pipe_lcl_*_master/*slr_auto_dest*}]
...
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME=~i_app/dcs_even/i_axi_pipe*slr_auto_dest* && (NAME~=*ar16.ar_auto* || NAME~=*aw16.aw_auto* || NAME~=*w16.w_auto*)}]
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME=~i_app/dcs_even/i_axi_pipe*slr_auto_src* && (NAME~=*r16.r_auto* || NAME~=*b16.b_auto*)}]
...
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME=~i_app/dcs_odd/i_axi_pipe*slr_auto_dest* && (NAME~=*ar16.ar_auto* || NAME~=*aw16.aw_auto* || NAME~=*w16.w_auto*)}]
add_cells_to_pblock $nicengine_plock [get_cells -hierarchical -filter {NAME=~i_app/dcs_odd/i_axi_pipe*slr_auto_src* && (NAME~=*r16.r_auto* || NAME~=*b16.b_auto*)}]

# NicEngine fits in SLR0
add_cells_to_pblock $nicengine_plock [get_cells [list \
